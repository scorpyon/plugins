...
//http://api.steampowered.com/ISteamUser/GetPlayerSummaries/v0002/?key=E2YJPKIVVMAIHGK3QNB1KPVOSP8MC058AFK&steamids=76561197960629521
...
$statement = $conn->prepare("INSERT INTO data(steamid, inserted, steampersona, timesvoted, serverapi, pluginversion)
         VALUES('".$player_steamid."',curdate(),'".$steamPersona."','".$voteCount."', '".$api_key_rok."', '". $plugin_version ."')");
$statement->execute();
     }else{
echo 0;
     }
